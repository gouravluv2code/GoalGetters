...
export const Regitration = () => {
  return (
    <div>
      {" "}
      <section className="bg-black dark:bg-black-900 w-4/5 m-auto">
        <div className="container flex items-center justify-center min-h-screen px-6 mx-auto
        bg-[url(https://cdn.wallpapersafari.com/10/60/BmOpKL.jpg)] bg-cover bg-left 
        ">

        
          <form className="w-full max-w-md mt-28 mb-20" >
            ...
            <div className="relative flex items-center mt-4">
              ...
              <input
                type="password"
                className="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:bg-gray-900
                 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 
                 focus:outline-none focus:ring focus:ring-opacity-40"
