...
export const Login = () => {
  ...
  return (
    <>
    <div className="h-full m-auto  py-20" >

<section className=" py-20 lg:py-[120px] bg-[url(https://cdn.wallpapersafari.com/89/20/H1nt7O.jpg)] bg-cover bg-center
w-4/5 m-auto
" >
  <div className="container mx-auto ">
    <div className="-mx-4 flex flex-wrap">
      <div className="w-full px-4">
        <div
          className="relative mx-auto max-w-[525px] bg-[#393053] overflow-hidden rounded-l bg-transparent py-16 px-10 text-center sm:px-12 md:px-[60px]"
        >
          <div className="mb-10 text-center md:mb-16">
            ...
            >
              ...
              className='bg-white rounded-3xl'
                src="https://i.ibb.co/XL3rRtC/pngegg-6.png"
                alt="logo"
              />
            </a>
          </div>
